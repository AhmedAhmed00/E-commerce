            ...
            <div className='grid bg-van pb-10 round  xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 container'>
                <div className='flex border p-5 bg-vanilla border-gray-400    items-center   '>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-slate-600'>12 Months Installments
                ...
                <div className='flex border p-5 bg-vanilla border-gray-400    items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-slate-600'>Capped at EGP 39 Per Order
                        </p>
                    </div>
                ...
                <div className='flex border p-5 bg-vanilla border-gray-400   items-center   '>
                    ...
                    <div>
                        <h3>
                            Transportation</h3>
                        <p className='text-sm text-slate-600'>Shop with confidence
