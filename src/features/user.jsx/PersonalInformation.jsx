...
export default function PersonalInformation() {
  ...
  const { isLoading, userData: { data: { email, name, phone } = {} } = {} } =
    useUser();
    ...
    <>
      <div className="flex justify-between">
        ...
        <button
          ...
          type="button"
          className="flex items-center gap-1 px-3 rounded-lg border"
        >
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {editMode ? (
          <input type="submit" className="submit-profile" value={"Update"} />
        ) : (
          ""
        )}
      </form>
