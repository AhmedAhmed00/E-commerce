...
export default function ForgotPass() {
  ...
  return (
    <section className="bg-gray-100 dark:bg-primary-3 ">
      <form
        className=" flex container    flex-col layout  "
      ...
      >
        <div className="xs:full  container md:w-1/2 m-auto py-5  border rounded-lg bg-white dark:bg-primary-2 shadow-md">
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm xs:w-full md:w-1/2 text-gray-500 w-">
              Enter the email you used to create your account so we can send you
              code for reseting your password
            </p>
          </div>
          <div className=" items-center  xs:w-full md:w-1/2 m-auto py-3">
            ...
            <Button
              type={"submit"}
              styles={"text-white bg-sky  w-full mb-0"}
              textContent={"Send"}
            ...
            <Button
              type={"button"}
              styles={
                "w-full border   bg-opacity-0  border-primary text-primary  "
              }
