  ...
  return (
    <section className=" dark:bg-primary-3 ">
      <form
        ...
        className="flex container layout flex-col items-center justify-center "
      >
        <div className="xs:full md:w-1/2  py-3  border rounded-lg bg-white dark:bg-primary-2 shadow-md ">
          ...
          <div className="flex xs:flex-col gap-3 md:flex-row px-3 mb-2 items-center  ">
            <input
              ...
              className="border outline-none px-2 py-0.5 rounded-md w-full dark:text-black"
              type="text"
          ...
          <div className="w-fit ms-auto px-4">
            <div className="flex items-end">
              <Button
                ...
                styles={
                  "text-primary  ms-3  me-2   px-3 bg-transparent border border-primary text-gray-800"
                }
                textContent={"Cancel"}
              />
