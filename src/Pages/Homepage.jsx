...
export default function Homepage() {
    ...
    const { categories, isLoading: categoriesLoading, isError: cateError } = useCategories()
    ...
    return (
        <>
            ...
            {brandsLoading && categoriesLoading && productsLoading ?
                <LoaderSpinner />
                : (productsError || cateError || brandsError) ? <div>errrrrrrrror</div> :
                    ...
                    <>
                        ...
                        <SectionHeader redContent={"Our Products"} textContent={"THE GOODS"} />
                        <Section  >
