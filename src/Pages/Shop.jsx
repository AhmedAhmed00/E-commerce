...
export default function Shop() {
    ...
    const { isError, isLoading, isFetching, data: { data: products, metadata: { nextPage, prevPage, numberOfPages, currentPage } = {} } = {} } = useProducts("8")
        ...
        <>
            {isError ? <div>errrrrrrrrrr</div> :
                ...
                <div className='container flex xs:flex-wrap md:justify-between gap-6 py-6'>
                    ...
                    <ShopSpecifications handleShowSpecList={handleShowSpecList} showSpecifcaitonsList={showSpecifcaitonsList} handleSpecificationsChange={handleSpecificationsChange} />

                    <div className='flex-1 bg-red'>
                        <ShopHaeder handleShowSpecList={handleShowSpecList} handleSpecificationsChange={handleSpecificationsChange} />
