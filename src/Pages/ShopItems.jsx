...
const responsiveStyles =
  "grid xs-grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4";
      ...
      {isFetching || isLoading ? (
          ...
          <div className="flex  w-fit gap-3 container mt-2  ">
            <Button
              ...
              styles={`text-white px-4 py-1 ${
                currentPage === 1 ? "bg-gray-400" : "bg-primary  dark:bg-sky "
              } `}
            />
            <Button
        ...
        <div className="grid">
          <p className="text-2xl">
            Sorry, These specifications are not available right now{" "}
          </p>
        </div>
      )}
    </>
